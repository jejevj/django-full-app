...
urlpatterns = [
    ...
    path("hapus_delivery/<str:no_delivery>/", hapus_delivery, name="hapus_delivery"),
    ...
    path("hapus_customer/<int:customer_id>/", hapus_customer, name="hapus_customer"),
    path("hapus_driver/<int:driver_id>/", hapus_driver, name="hapus_driver"),
